 ...
 * @endcode
 */
$settings['hash_salt'] = 'eAKf_5FRjXka3KxIglnbLzEGhQ44EI7E3Lb06u5dUYePIQ8iHJYu4HY5WZ1-MB4fgPYWV2u4RQ';
...
$settings['site_studio_sync'] = '../config/cohesion/sync';

$config["cohesion.settings"]["api_key"] = "<site_studio_api_key>";
$config["cohesion.settings"]["organization_key"]  = "<site_studio_organization_key>";
